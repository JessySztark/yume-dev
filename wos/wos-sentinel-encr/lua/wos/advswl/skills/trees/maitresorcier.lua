...
TREE.UserGroups = { "superadmin" }
 
--Add user groups that are allowed to use this tree. If anyone is allowed, set this to FALSE ( TREE.UserGroups = false )
TREE.JobRestricted = { "TEAM_MAITRESO" }
...
TREE.Tier[1][1] = {
    ...
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Canalisation" ) 
    end,
}
TREE.Tier[1][2] = {
    Name = "Saut de Force",
    ...
    OnPlayerDeath = function( ply ) end,
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Saut De Force" ) 
    end,
}
TREE.Tier[2][1] = {
    ...
    OnPlayerDeath = function( ply ) end,
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Attraction De Force" ) 
    end,
}
TREE.Tier[2][2] = {
    ...
    OnPlayerDeath = function( ply ) end,
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Pousée De Force" ) 
    end,
}
TREE.Tier[2][3] = {
    ...
    OnPlayerDeath = function( ply ) end,
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Répulsion De Force" ) 
    end,
}
TREE.Tier[3][1] = {
    ...
    OnPlayerDeath = function( ply ) end,
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Éclair De Force" ) 
    end,
}
TREE.Tier[4][1] = {
    Name = "Frappe Éclair",
    ...
    OnPlayerDeath = function( ply ) end,
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Frappe D'Éclair" ) 
    end,
}
TREE.Tier[4][2] = {
    ...
    OnPlayerDeath = function( ply ) end,
    OnSaberDeploy = function( wep ) 
        wep:AddForcePower( "Tempête De Force" ) 
    end,
}